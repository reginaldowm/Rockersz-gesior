<div id="LayerPop" style="display:block; position:absolute; left:0px; top:-600px; background-color:#1e1e22; width:200%; height:320%; z-index:100;margin:-340px;opacity:0.85;"></div>
<div id="LayerPop2" style="position: absolute; left: 30px; top: -480px; z-index: 5000;"><a href="?subtopic=accountmanagement" target="_BLANK"><img src="images/popup.png" class="imgBorder"></a><br><a href="javascript:void();" onClick="document.getElementById('LayerPop').style.display = 'none';document.getElementById('LayerPop2').style.display = 'none'">
<span style="color:white"> <center>FECHAR</center></span></div>
<?php
$main_content .= '
															...
															<table border="0">
																<tr>
																	<td style="text-align: center; font-weight: bold;">
																		<font color="white">Top guilds:</font>
																	</td>
																</tr>
															</table>
														</div>
...
$news_content .= '
   ...
   <img class="Title" src="layouts/tibiacom/images/header/headline-featuredarticle.gif" alt="Contentbox headline" />
    <div class="Border_2">
        <div class="Border_3">
            <div class="BoxContent" style="background-image:url('.$layout_name.'/images/content/scroll.gif);">
